...
Other folders
* dotnet-kafka-connecter is a folder for testing connections. It creates a producer and a consumer and sort of feed it self to see if the kafka setup works.